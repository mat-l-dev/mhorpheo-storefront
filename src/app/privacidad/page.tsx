      ...
      <main className="container mx-auto px-4 py-12 sm:px-6 sm:py-16 lg:px-8">
        ...
        >
          ...
          <div className="prose prose-lg dark:prose-invert max-w-none">
            ...
            <p>
              <strong>NO vendemos ni alquilamos</strong> tu información personal
              a terceros.
            </p>
            ...
            <p>
              Puedes deshabilitar cookies en tu navegador, pero algunas
            ...
            <p>
              ...
              aseguramos de que cumplan con estándares de protección
              equivalentes.
            </p>
            ...
            <div className="mt-12 rounded-lg border border-amber-200 bg-amber-50 p-6 dark:border-amber-900 dark:bg-amber-950/20">
              <p className="mb-0 text-sm text-amber-800 dark:text-amber-200">
                ...
                ser revisado por un experto legal antes del lanzamiento oficial.
              </p>
            </div>
          </div>
