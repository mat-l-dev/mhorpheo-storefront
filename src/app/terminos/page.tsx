        ...
        >
          ...
          <div className="prose prose-lg dark:prose-invert max-w-none">
            ...
            <p>
              ...
              &ldquo;nosotros&rdquo;, &ldquo;nos&rdquo; y &ldquo;nuestro&rdquo;
              se refieren a Mhorpheo. Al visitar nuestro sitio y/o comprar algo
              de nosotros, participas en nuestro &ldquo;Servicio&rdquo; y
              aceptas estar vinculado por los siguientes términos y condiciones.
            </p>
            ...
            <div className="mt-12 rounded-lg border border-amber-200 bg-amber-50 p-6 dark:border-amber-900 dark:bg-amber-950/20">
              <p className="mb-0 text-sm text-amber-800 dark:text-amber-200">
                <strong>Nota:</strong> Este documento es un placeholder. Debe
                ser revisado por un abogado antes del lanzamiento oficial.
              </p>
            </div>
          </div>
